    ...
    <form method="POST" action="{{ route('auth') }}">
        ...
        <div class="card mt-3 rounded-sm p-5 lg:p-7">
            ...
            <label class="mt-4 block">
                ...
                <span class="relative mt-1.5 flex" data-pw-wrapper>
                    ...
                    <button type="button" onclick="togglePw(this)"
                            class="absolute right-2 flex h-full items-center text-slate-400 hover:text-primary dark:hover:text-accent focus:outline-none">
            ...
            <div class="mt-4 flex items-center justify-between space-x-2">
                ...
                <a href="{{ route('password.request') }}" class="text-xs text-slate-400 transition-colors line-clamp-1 hover:text-slate-800 focus:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100 dark:focus:text-navy-100">@lang('locale.forgot_password') ?</a>
            </div>
