    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6">
                ...
                <div class="relative mt-1 w-3/4" data-pw-wrapper>
                    <x-text-input
                        id="password"
                        name="password"
                        type="password"
                    ...
                    <button type="button" onclick="togglePw(this)"
                            class="absolute inset-y-0 right-2 flex items-center text-slate-400 hover:text-indigo-500 focus:outline-none">
